daysmart_acc = "e69b49d3-fd2b-46a3-98a7-d51bdde5de74"; 
daysmart_iframe_width =1416; 
daysmart_iframe_height =600;
...
var widget = "<div id='externalBookingPluginContainer' style='position:relative; overflow:hidden; max-width:" + daysmart_iframe_width + "px; width:100%; min-height:" + daysmart_iframe_height + "px;'><iframe id='externalBookingPlugin' style='width:100%; min-height:" + daysmart_iframe_height + "px;' src=\"http://plugin.myonlineappointment.com/External/BookingPlugin/?guid=" + daysmart_acc + "\" frameBorder=\"0\"></iframe></div>";
document.write(widget);

iFrameResize({ log: true, heightCalculationMethod: "bodyScroll", tolerance: 100 }, ['#externalBookingPlugin']);
